...
public class End2end {
    ...
    public  static Collection<SampleOrg> checkConfig(Config config) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, MalformedURLException, org.hyperledger.fabric_ca.sdk.exception.InvalidArgumentException {
        out("\n\n\nRUNNING: End2endIT.\n");
    ...
    public static void main(String[] args) {
        ...
        try {
            Collection<SampleOrg> sampleorgs= checkConfig(testConfig);
            ////////////////////////////
            // Setup client
